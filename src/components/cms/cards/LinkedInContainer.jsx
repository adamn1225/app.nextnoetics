...
export const LinkedInContainer = ({ background, padding = 0, borderColor = 'gray-400', containerType, img = defaultImage, alt, objectFit = 'contain', objectPosition = 'center', overlayColor = '#ffffff', overlayOpacity = 0.9, children }) => {
  ...
  const isLinkedIn = containerType === 'linkedin';
...
export const LinkedInContainerSettings = () => {
...
LinkedInContainer.craft = {
  ...
  related: {
    settings: LinkedInContainerSettings,
  },
  displayName: "Canvas",
  rules: {
    canDrag: () => false,
