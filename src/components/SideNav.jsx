...
const SideNav = ({ session }) => {
  ...
  return (
    <aside className={`relative left-0 top-0 z-50 bg-gray-950 h-[105vh] pb-28 -mt-12 -pt-12 text-white transition-all duration-300 ${isCollapsed ? 'w-14' : 'w-44'} overflow-hidden h-[105vh] relative z-50`}>
      {loading && (
